...
import { ExpensiveComponent, MemoExpensiveComponent } from '../ExpensiveComponent';

export default function SecondCasePage() {
  ...
  return (
    <div>
      ...
      이전 렌더된 결과와 비교하여 DOM 업데이트를 결정한다. 만약 렌더 결과가 이전과 다르다면,
       React는 DOM을 업데이트한다.
